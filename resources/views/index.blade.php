...
@section('content')
  ...
  <section class="hero" id="hero">
        ...
        <div class="container">
            ...
            <div class="headline-description">
                ...
                <div class="single-animation">
                    ...
                    <a class="btn cta-btn" href="#discover-our-menu">Explore</a>
    ...
    <section class="discover-our-menu" id="discover-our-menu">
    ...
    <div class="container">
        <div class="restaurant-info">
            ...
            <div class="restaurant-description animate-right">
                ...
                <a href="#ourmenusection" class="btn body-btn"> View the full menu</a>
            </div>
        </div>
    </div>
</section>
...
<!--Discover our Menu part ends-->
    ...
    <section class="ourmenusection" id="ourmenusection">
		<div class="container">
			<div class="row">
				<div class="col-sm-3">
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                            <div class="productinfo text-center" style="margin-bottom: 2rem">
                                                <a href="{{ url('product/'.$product->id) }}"><img src="{{ asset('images/backend_images/products/medium/'.$product->image) }}" alt=""/></a>
                                                <h2 class="font-size-20">NPR {{ $product->price }}</h2>
                                                <p>{{ $product->product_name }}</p>
                                                <a href="{{ url('product/'.$product->id) }}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i> Grab It</a>
                                            </div>
