         ...
         <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/add-attributes/'.$productDetails->id) }}" name="add_attribute" id="add_attribute"> {{ csrf_field() }}
             ...
             <div>
                <input type="text" name="sku[]" id = "sku" placeholder="SKU" style="width:120px" required="" />
                 <input type="text" name="pound[]" id = "pound" placeholder="Pound" style="width:120px" required="" />
                  <input type="text" name="price[]" id = "sku" placeholder="Price" style="width:120px" required="" />
                   <input type="text" name="stock[]" id = "sku" placeholder="Stock" style="width:120px" required="" />
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            <form action="{{ url('/admin/add-attributes/'.$productDetails->id) }}" method="post"> {{ csrf_field() }}
